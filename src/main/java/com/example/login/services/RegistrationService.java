...
import com.example.login.models.EmailSender;
...
public class RegistrationService {
    ...
    public String confirmToken(String token) {
        ConfirmationToken cToken = confirmationTokenService.getToken(token).orElseThrow(() -> new IllegalStateException("There's no token"));
        ...
        userService.enableAppUser(cToken.getAppUser().getEmail());
